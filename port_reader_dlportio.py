...
class port_reader_dlportio(item.item, generic_response.generic_response):
	...
	def __init__(self, name, experiment, string=None):
		...
		self.item_type = "port_reader_dlportio"
...
class qtport_reader_dlportio(port_reader_dlportio, qtplugin.qtplugin):
	...
	def __init__(self, name, experiment, string=None):
		...
		port_reader_dlportio.__init__(self, name, experiment, string)		
